...
def save_translation(user_id, original_text, translated_text, source_language, target_language):
    # Save translation details to Firestore
    db.collection('whatsapp_translations').add({
        'user_id': user_id,
        'original_text': original_text,
        'translated_text': translated_text,
        'source_language': source_language,  # Language being translated from
        'target_language': target_language,  # Language being translated to
