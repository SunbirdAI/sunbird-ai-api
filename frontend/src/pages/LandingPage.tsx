    ...
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300 selection:bg-primary-500 selection:text-white">
      ...
      <div className="relative pt-32 pb-16 sm:pt-40 sm:pb-24 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center overflow-hidden">
        ...
        >
          <h1 className="relative text-4xl sm:text-5xl lg:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-6">
            ...
            <span className="text-primary-600 dark:text-primary-500">Sunbird AI API</span>
          </h1>
      ...
      <div className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Link to="/login" className="group p-6 rounded-2xl bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 border-b-4 hover:border-primary-500 dark:hover:border-primary-500 transition-all hover:shadow-2xl hover:-translate-y-1 backdrop-blur-sm">
            <div className="w-12 h-12 rounded-xl bg-primary-50 dark:bg-primary-900/20 flex items-center justify-center text-primary-600 dark:text-primary-400 mb-4 group-hover:scale-110 transition-transform">
              <Activity size={24} />
            </div>
